...
def letterbox_resize(image, target=512, mask=None):
    """
...
class ForensicDataset(Dataset):
    ...
    """
    def __init__(self, df, mode="train", target_size=512):
    ...
    def __getitem__(self, idx):
        ...
        # JPG probe_mask 압축 아티팩트 완화: threshold 후 3×3 morphological closing
...
def extract_features(image_rgb, heatmap, threshold=0.5, top_k=5, min_area=400):
    """
